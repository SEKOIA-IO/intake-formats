...
- **Linting**: Verify smart-descriptions, test files, manifest are formatted with `utils/linter.py`, with the command line `uv run python linter.py check --changes` and the working directory as `utils/`
