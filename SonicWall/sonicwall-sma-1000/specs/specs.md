...
| --- | --- | --- |
| sonicwall.sma.1000.app_id | TYPE MESSAGE | Application/service identifier |
| sonicwall.sma.1000.certificate.error_code | TYPE MESSAGE | Certificate verification error code |
| sonicwall.sma.1000.certificate.error_reason | TYPE MESSAGE | Certificate verification reason |
| sonicwall.sma.1000.epc.query_result | TYPE MESSAGE | EPC evaluation result |
| sonicwall.sma.1000.policy.log_type | TYPE MESSAGE | Access policy log type (`CSACL`, `EWACL`, `WPACL`, `NEACL`) |
...
| Custom Field | Log Element | Comment |
| --- | --- | --- |
| sonicwall.sma.1000.management.class_name | MESSAGE | Java class extraction (if needed) |
| sonicwall.sma.1000.syslog_facility | local4.LEVEL | Syslog facility (`local4`) |
...
| Custom Field | Log Element | Comment |
| --- | --- | --- |
| sonicwall.sma.1000.change_type | message | Derived change category |
...
| Custom Field | Log Element | Comment |
| --- | --- | --- |
| sonicwall.sma.1000.console_action | HTTP REQUEST LINE | Derived action |
| sonicwall.sma.1000.http_status_class | STATUS | Status class derivation |
...
| Custom Field | Log Element | Comment |
| --- | --- | --- |
| sonicwall.sma.1000.api_endpoint | request | API endpoint extraction |
| sonicwall.sma.1000.http_status_class | HTTP-return-code | 2xx/3xx/4xx/5xx class |
...
| Custom Field | Log Element | Comment |
| --- | --- | --- |
| sonicwall.sma.1000.export_state | exported (URL parameter) | Exported/unexported selector |
| sonicwall.sma.1000.registered_device_count | deviceCount (URL parameter) | Registered device count filter |
| sonicwall.sma.1000.unregistered_device.limit | limit (URL parameter) | Max entries to export |
...
| Custom Field | Log Element | Comment |
| --- | --- | --- |
| sonicwall.sma.1000.workplace.policy_status | MESSAGE | `PCL_STATUS_*` raw value |
| sonicwall.sma.1000.workplace.shortcut_type | MESSAGE | URI-scheme derived type (`web`/`network`) |
| sonicwall.sma.1000.workplace.team_session_id | MESSAGE | `teamSessionId` extraction |
